...
public class ClaseSpecificServiceImplementation extends TableGenericServiceImplementation {

    public ClaseSpecificServiceImplementation(HttpServletRequest request) {
        super(request);
    }
