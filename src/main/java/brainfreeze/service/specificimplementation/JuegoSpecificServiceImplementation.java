...
public class JuegoSpecificServiceImplementation extends TableGenericServiceImplementation {

    public JuegoSpecificServiceImplementation(HttpServletRequest request) {
        super(request);
    }
