...
public class ComentarionoticiaSpecificServiceImplementation extends TableGenericServiceImplementation {

    public ComentarionoticiaSpecificServiceImplementation(HttpServletRequest request) {
        super(request);
    }
