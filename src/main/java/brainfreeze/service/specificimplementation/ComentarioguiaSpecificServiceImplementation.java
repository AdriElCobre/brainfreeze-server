...
public class ComentarioguiaSpecificServiceImplementation extends TableGenericServiceImplementation {

    public ComentarioguiaSpecificServiceImplementation(HttpServletRequest request) {
        super(request);
    }
